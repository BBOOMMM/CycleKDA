...
def parse_args():
	...
	parser.add_argument("--pred-path", type=str, default="/home/chenxuanyu/code/CycleKDA/pred2/gla_test_pred.npy")
	parser.add_argument("--output-dir", type=str, default="/home/chenxuanyu/code/CycleKDA/pred2/gla")
	parser.add_argument("--prefix", type=str, default="gla")
